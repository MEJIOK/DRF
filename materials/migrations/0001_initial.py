    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(max_length=255, verbose_name="Описание курса"),
                ),
            ],
            options={
                "verbose_name": "Курс",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "video",
                    models.FileField(
                        blank=True, null=True, upload_to="materials/video"
                    ),
                ),
                (
                    "preview",
                    models.ImageField(
                        blank=True, null=True, upload_to="materials/image"
                    ),
                ),
            ],
            options={
